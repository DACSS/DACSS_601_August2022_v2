...
```{r}
#I don't know what happened, but as I filtered down to one animal in one geographic region, the tables only showed ONE weight (not the range that's in the original table). I tried goats and sheep and it happened both times.
```

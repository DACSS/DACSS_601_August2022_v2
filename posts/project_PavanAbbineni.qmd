...
#### Project Goals
My main objective in this project is focused on finding th relationship between the bmi (Body Mass Index) using average glucose level and age of a patient. And also checking the dependence between some of the categorical variables like gender, residence type and stroke.

My main objective in this project is focused on finding the best lifestyle choices inorder to 
...
You may have a question on why we chose the people who had a stroke and not the dataset with the people who haven't had a stroke. It's because of the median of the data of the two datasets which is shown below.

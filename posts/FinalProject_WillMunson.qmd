...
Any soil within a pH between 5.5 and 7.5 is considered a healthy soil. As we can see here, we have one soil texture type that appears to be too acidic - silt. The other samples that were purely one texture - sand and clay - are right on the line of being too acidic. 
